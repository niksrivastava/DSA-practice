package com.nikhil.OOP.Generics;
...
public class WildCardExample<T extends Number> {
    ...
    public WildCardExample(int[] data){
    ...
    public void getList(List<Number> list){
        ...
        //here you can only pass the Number type if you are not extendin the Number class like this --> List<? extends Number> list
    }
